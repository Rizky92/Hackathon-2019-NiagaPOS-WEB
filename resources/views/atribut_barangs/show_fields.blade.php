...
<div class="form-group row mb-1">
    ...
    <div class="col-md-9">
        <p class="form-control">{!! $atributBarang->id !!}</p>
    </div>
</div>
...
<div class="form-group row mb-1">
    ...
    <div class="col-md-9">
        <p class="form-control">{!! $atributBarang->nama !!}</p>
    </div>
</div>
...
<div class="form-group row mb-1">
    ...
    <div class="col-md-9">
        <p class="form-control">{!! $atributBarang->store_id !!}</p>
    </div>
</div>
...
<div class="form-group row mb-1">
    ...
    <div class="col-md-9">
        <p class="form-control">{!! $atributBarang->created_at !!}</p>
    </div>
</div>
...
<div class="form-group row mb-1">
    ...
    <div class="col-md-9">
        <p class="form-control">{!! $atributBarang->deleted_at !!}</p>
    </div>
</div>
...
<div class="form-group row mb-1">
    ...
    <div class="col-md-9">
        <p class="form-control">{!! $atributBarang->updated_at !!}</p>
    </div>
</div>
