                        ...
                        <div class="card-body card-dashboard">
                            <div class="row">
                                ...
                                <div class="float-left mt-1 ml-1">
                                    <h3 class="text-uppercase"><b class="blue-dark">Kelurahans</b></h3>
                                    <p>Data semua Kelurahans yang di simpan.</p>
                                        ...
                                        <div class="card overflow-hidden">
                                            <div class="card-content">
                                                <div class="media bg-grey bg-lighten-4 align-items-stretch">
                                                    ...
                                                    <!-- <a href="{!! route('kelurahans.create') !!}" class="bg-blue p-1 media-middle text-center ">
                                                        <i class="fa fa-plus-square-o font-large-1 text-white"></i>
                                                        <h5 class="text-white">Tambah</h5>
                                                    </a> -->
                                                    <a class="btn btn-success pull-right" style="margin-top: -10px;margin-bottom: 5px" href="{!! url('sync_data_kelurahan') !!}">Synchronize Data Api</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
