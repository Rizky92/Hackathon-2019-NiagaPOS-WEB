...
<div class="form-group row mb-1">
    ...
    <div class="col-md-9">
        <p class="form-control">{!! $satuan->id !!}</p>
    </div>
</div>
...
<div class="form-group row mb-1">
    ...
    <div class="col-md-9">
        <p class="form-control">{!! $satuan->nama !!}</p>
    </div>
</div>
...
<div class="form-group row mb-1">
    ...
    <div class="col-md-9">
        <p class="form-control">{!! $satuan->created_at !!}</p>
    </div>
</div>
...
<div class="form-group row mb-1">
    ...
    <div class="col-md-9">
        <p class="form-control">{!! $satuan->updated_at !!}</p>
    </div>
</div>
...
<div class="form-group row mb-1">
    ...
    <div class="col-md-9">
        <p class="form-control">{!! $satuan->deleted_at !!}</p>
    </div>
</div>
...
<div class="form-group row mb-1">
    ...
    <div class="col-md-9">
        <p class="form-control">{!! $satuan->satuan_id !!}</p>
    </div>
</div>
