                        ...
                        <div class="card-body card-dashboard">
                            <div class="row">
                                ...
                                <div class="float-left mt-1 ml-1">
                                    <h3 class="text-uppercase"><b class="blue-dark">Pelanggan Has Voucher</b></h3>
                                        ...
                                        <div class="card overflow-hidden">
                                            <div class="card-content">
                                                <div class="media bg-grey bg-lighten-4 align-items-stretch">
                                                    ...
                                                    <a href="{!! route('pelangganHasVouchers.create') !!}" class="bg-blue p-1 media-middle text-center ">
                            ...
                            @include('pelanggan_has_vouchers.table')
