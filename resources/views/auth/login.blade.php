...
<body class="vertical-layout vertical-content-menu 1-column blank-page"
        ...
        <div class="content-body">
            <section class="flexbox-container">
                <div class="col-12 d-flex align-items-center justify-content-center">
                    <div class="col-md-4">
                        <div class="card rounded-1 box-shadow-1 border-grey border-lighten-3 m-0 p-1">
                            <div class="order-0">
                                <div class="card-title text-center">
                                    <div class="p-1">
                                        <img src="{{asset('app-assets/images/logo/login_logo.png')}}" alt="branding logo">
                                    </div>
                                </div>
                                <h6 class="card-subtitle line-on-side text-muted text-center font-small-3 ml-1 mr-1">
                                    <span class="font-medium-1" style="font-family: Rubik">Silahkan login dengan akun anda</span>
                                </h6>
                            </div> 
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="form-horizontal form-simple" method="post" action="{{ url('/login')}}">
                                        ...
                                        <fieldset class="form-group position-relative has-icon-left {{ $errors->has('password') ? ' has-error' : '' }}">
                                            <input type="password" class="form-control form-control-lg input-lg" placeholder="Kata Sandi" name="password">
                                            <div class="form-control-position">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-6 col-12 text-center text-md-left">
                                                <fieldset>
                                                    ...
                                                    <label for="remember-me" style="margin-left: 8px"> Ingat Login</label>
                                                </fieldset>
                                            </div>
                                            <div class="col-md-6 col-12 text-center da text-md-right"><a href="{{ url('/password/reset') }}" class="card-link">Lupa Password ?</a></div>
                                        </div>
                                        {{----}}
                                        <button type="submit" class="btn btn-info btn-lg btn-darken-1 box-shadow-1 btn-block">Login Admin</button>

                                    </form>
                                    {{----}}
                                </div>
                            </div>
                            <div class="card-footer rounded-1">
                                <div class="">
                                    {{--<p class="float-sm-left text-center m-0"><a href="recover-password.html" class="card-link">Recover password</a></p>--}}
                                    <p class=" text-center m-0">Buat akun admin baru? <a href="{{ url('/register') }}" class="card-link success">Sign Up</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
