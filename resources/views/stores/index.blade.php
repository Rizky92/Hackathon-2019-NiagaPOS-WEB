                            ...
                            <div class="row">
                                <div class="float-left mt-1 ml-2">
                                    <div class="align-self-center">
                                        <i class="fa fa-map-marker dark font-large-3"></i>
                                    </div>
                                </div>
                                <div class="float-left mt-1 ml-1">
                                    <h3 class="text-uppercase"><b class="blue-dark">Store</b></h3>
                                        ...
                                        <div class="card overflow-hidden">
                                            <div class="card-content">
                                                <div class="media bg-grey bg-lighten-4 align-items-stretch">
                                                    ...
                                                    <a href="{!! route('stores.create') !!}" class="bg-blue p-1 media-middle text-center ">
